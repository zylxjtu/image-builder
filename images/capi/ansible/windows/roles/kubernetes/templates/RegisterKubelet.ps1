...
$KubeletCommandLine =  "`"" + "\`"" + "{{ kubernetes_install_path }}\kube-log-runner.exe" + "\`" " + "--log-file=/var/log/kubelet/kubelet.log " + "{{ kubernetes_install_path }}\kubelet.exe " + $KubeletArgListStr + "`""
